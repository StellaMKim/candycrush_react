...
const App = () => {
  ...
  const dragEnd = (e) => {
    ...
    currentColorArrangement[squareBeingReplacedId] = squareBeingDraggedId.style.backgroundColor
    currentColorArrangement[squareBeingDraggedId] = squareBeingReplacedId.style.backgroundColor
